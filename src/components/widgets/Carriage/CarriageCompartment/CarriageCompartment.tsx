...
import PotentialPassengers from '../../../widgets/Passenger/PotentialPassengers/PotentialPassengers';

import carriageCompartment from './img/carriage-compartment-lux.svg';
